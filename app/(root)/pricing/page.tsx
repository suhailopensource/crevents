    ...
    <Card
        ...
        <CardFooter className="mt-2">
            <Button className="relative inline-flex w-full items-center justify-center rounded-md bg-black text-white dark:bg-white px-6 font-medium  dark:text-black transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <Link href={title == "Pro" ? "https://buy.stripe.com/test_eVaaHSduc8Xv6hWfYZ" : "https://buy.stripe.com/test_7sIbLW9dW1v37m0288"}>{actionLabel}</Link>
            </Button>
        </CardFooter>
    </Card>
)
    ...
    const plans = [
        {
            ...
            monthlyPrice: 8,
            yearlyPrice: 90,
            description: "for clubs with upto 2 Events/Month",
            features: ["2 events/month", "SEO optimization", "will show more in related events"],
        ...
        },
        {
            ...
            monthlyPrice: 15,
            yearlyPrice: 160,
            description: "Perfect for clubs with upto 5 Events/month",
            features: ["5 events/month", "SEO optimization", "24/7 support", "digital marketing support"],
            actionLabel: "Subscribe",
            popular: true,
        },
        {
            title: "Enterprise",
            price: "Custom",
            description: "For clubs with more than 5 Events/month",
            features: ["The events/month you want", "SEO optimization", "external advertising free of cost", "24/7 support", "digital marketing support"],
